...
namespace TheraBytes.BetterUi
{
    ...
    public class BetterLayoutElement : LayoutElement, IResolutionDependency
    {
        ...
        void Apply()
        {
            ...
            base.minWidth =         (s.MinWidthEnabled)         ? MinWidthSizer.CalculateSize()         : -1;
            base.minHeight =        (s.MinHeightEnabled)        ? MinHeightSizer.CalculateSize()        : -1;
            base.preferredWidth =   (s.PreferredWidthEnabled)   ? PreferredWidthSizer.CalculateSize()   : -1;
            base.preferredHeight =  (s.PreferredHeightEnabled)  ? PreferredHeightSizer.CalculateSize()  : -1;
